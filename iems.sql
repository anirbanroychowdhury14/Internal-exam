...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2020 at 11:34 AM
...
(11, '1st', 'CSE', 1101, 1170, 1101),
(12, '2nd', 'CSE', 1201, 1260, 1201),
(13, '3rd', 'CSE', 1301, 1360, 1301),
(14, '4th', 'CSE', 1401, 1470, 1401),
...
CREATE TABLE `gnotice` (
  ...
  `Gnotice_file` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `gnotice`
  MODIFY `Gnotice_id` bigint(100) NOT NULL AUTO_INCREMENT;
